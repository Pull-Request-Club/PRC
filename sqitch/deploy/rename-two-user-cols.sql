-- Deploy prc:rename-two-user-cols to sqlite
...
INSERT INTO user
  SELECT
    ...
    last_login_time,
    last_repository_sync_time as last_personal_repo_sync_time,
    last_organization_sync_time as last_org_repo_sync_time,
