-- Revert prc:redo-user-table from sqlite
...
INSERT INTO user
    SELECT
        ...
        scheduled_delete_time,
        is_deactivated,
        case is_receiving_assignments when 1 then 10 else 0 end as assignment_level,
        0,
        github_id,
        github_login,
        github_email,
        github_profile,
        github_token,
        last_repository_sync_time as last_repos_sync
    FROM user_backup
;
